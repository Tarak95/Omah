        ...
        <div className='service_itemss'>
          <div className='service_item'>
            ...
            <div>
              <a href='/service-detail'>
                Baca lebih Lanjut<i className="fa-solid fa-arrow-right"></i>
              </a>
            </div>
          </div>
          ...
          <div className='service_item'>
            <div>
              ...
              <p>Pembiayaan KPR untuk pembeli rumah dengan skema pembiayaan jika diperlukan dan dilanjutkan proses sertifikasi HGB.</p>
            </div>
            <div>
              <a href='/service-detail'>
                Baca lebih Lanjut<i className="fa-solid fa-arrow-right"></i>
